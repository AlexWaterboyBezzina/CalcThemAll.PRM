...
datatable(pollutant_info, options = list(pageLength = 10,lengthMenu = c(5, 10, 15, 20), scrollX = T))
...
datatable(Kanto_pollutants_LOR_treated, options = list(pageLength = 10,lengthMenu = c(5, 10, 15, 20), scrollX = T)) #Kanto pollutant concentrations after treatment, LORs should be replaced with either 0.0000001 or LOR replacement value
