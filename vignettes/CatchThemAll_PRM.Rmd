...
knitr::include_graphics("img/Guidelines Table.png")
```
...
plot_daily_PRM(daily_PRM_data = Lavendar_Town_2017_2018_PRM,
               ...
               wet_seaon_length = 182, #length of wet season or high risk window
               PRM_group = "PSII PRM") #PRM group to plot, for all PRM = "Total PRM"
...
Kanto_wet_season_PSII_PRM <- calculate_wet_season_average_PRM(daily_PRM_data = Kanto_daily_PRM, PRM_group = "PSII PRM") #this calculates the wet season average PRM for only PSII pollutants
