...
datatable(Kant0_pesticides_LOR_treated, options = list(pageLength = 10,lengthMenu = c(5, 10, 15, 20), scrollX = T)) #Kant0 pesticide concentrations after treatment, LORs should be replaced with either 0.0000001 or LOR replacement value
...
head(Kant0_pesticides_LOR_treated) #Kant0 pesticide concentrations after LOR treatment
...
Kant0_wet_season_PSII_PRM <- calculate_wet_season_average_PRM(daily_PRM_data = Kant0_daily_PRM, PRM_group = "PSII Herbicide PRM") #this calculates the wet season average PRM for only PSII pesticides
