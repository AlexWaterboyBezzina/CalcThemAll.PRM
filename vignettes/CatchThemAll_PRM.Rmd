...
library(DT)
pesticide_info <- CatchThemAll.PRM::pesticide_info #the original 22 pesticides
...
head(Kanto_pesticides_LOR_treated) #Kanto pesticide concentrations after LOR treatment
...
Kanto_wet_season_PSII_PRM <- calculate_wet_season_average_PRM(daily_PRM_data = Kanto_daily_PRM, PRM_group = "PSII Herbicide PRM") #this calculates the wet season average PRM for only PSII pesticides
