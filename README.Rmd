...
The Pesticide Risk metric is an adaptable version of the pesticide risk metric that allows for the addition of new pesticides provided SSD information is available and will hopefully be more widely useful.
...
1. Adding new pesticide SSD information to the metric `add_your_own_pesticide()`
...
An example of how to run this package is provided below using the included `Kant0_pesticides` concentration data.
