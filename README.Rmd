...
[![CRAN status](https://www.r-pkg.org/badges/version/CalcThemAll.PRM)](https://CRAN.R-project.org/package=CalcThemAll.PRM)
<!-- badges: end -->
...
You can install the development version of CalcThemAll.PRM from [GitHub](https://github.com/) with:
...
An example of how to run this package is provided below using the included `Canto_pesticides` concentration data.
