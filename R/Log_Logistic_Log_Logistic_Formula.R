...
#' scale = Pesticide_Info$scale[Pesticide_Info$analyte == "23"],
#' shape_location = Pesticide_Info$shape_location[Pesticide_Info$analyte == "23"],
#' scale_2 = Pesticide_Info$scale_2[Pesticide_Info$analyte == "23"],
#' shape_location_2 = Pesticide_Info$shape_location_2[Pesticide_Info$analyte == "23"],
#' weight = Pesticide_Info$weight[Pesticide_Info$analyte == "23"])
#'
